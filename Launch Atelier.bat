...
echo Preparing Atelier for first use...
if exist "%APP_PYTHON%" (
...
:install
echo Installing Atelier dependencies. This is only needed once...
...
:no_python
echo.
echo Atelier requires Python 3.12 or newer.
...
:setup_failed
echo.
echo Atelier could not finish its one-time setup.
